...
- **Dataset Link:** [M3CoT on Hugging Face])
...
### Step 2: Filter and Convert Dataset
...
### Step 3: Generate the Image Pool with SAM2

This step uses the pre-configured **Segment Anything Model 2 (SAM2)** to perform object detection on the dataset images. The results are stored in an "image pool" file, which is used during the reasoning process.

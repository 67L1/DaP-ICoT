# SAM2 Setup for DaP-ICoT

This directory contains the **Segment Anything Model 2 (SAM2)** repository, which is used for object detection during the data pre-processing stage of the DaP-ICoT project.
...
git clone <sam2 repository URL> sam2
```
